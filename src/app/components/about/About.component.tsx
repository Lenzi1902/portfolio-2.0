...
const AboutComponent = () => {
  ...
  return (
    <section className="min-h-[140vh] max-w-screen px-[5rem] py-[3rem] flex gap-[2rem] items-center" id="section-about" wb-section="about">
      <div className=" w-[120rem]">
        <img src="./sketsa-foto-portfolio.png" alt="" className=" rounded-xl" />
      </div>
      <div className="flex flex-col gap-[2rem]">
        <h1 className=" font-inter font-extrabold text-[3.33rem]  reveal-text">Nice to meet you all.</h1>
        <div className=" text-[1.8rem] flex flex-col gap-[2rem] w-[90%]">
