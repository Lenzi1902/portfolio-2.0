...
const LinkMediaSocialContact = () => {
  return (
    <div className=" flex flex-col md:flex-row gap-[4rem]">
      ...
      <GsapMagnetic>
        <Link href={"https://www.instagram.com/xlennzii/"} className=" text-black  h-[3.6rem] hidden md:flex text-[1.6rem] rounded-[0.375rem] text-center items-center justify-center gap-[1rem]">
          <span className=" w-[0.938rem] h-[0.938rem] bg-black rounded-[100%]"></span>
          Instagram
        </Link>
      </GsapMagnetic>
      <GsapMagnetic>
        <Link href={"#"} className=" text-black w-[15rem] h-[3.6rem] hidden md:flex  text-[1.6rem] rounded-[0.375rem] text-center items-center justify-center gap-[1rem]">
          <span className=" w-[0.938rem] h-[0.938rem] bg-black rounded-[100%]"></span>
          Linkedin
        </Link>
      </GsapMagnetic>
